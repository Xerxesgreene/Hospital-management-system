...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #001f3f; padding: 30px; margin: 0; padding-right: -80px;">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link active" href="BillAdmin.jsp">VIEW ALL BILLS</a></li>
