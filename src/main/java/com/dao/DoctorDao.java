...
public class DoctorDao {
	...
	public boolean approveAppointment(int id) {
	    // TODO: Replace the placeholders with the actual names used in your database
	    String updateQuery = "UPDATE appointment SET approval_status = 'approved' WHERE id = ?";
	    ...
	    try (Connection connection = DBConnect.getConn();
	        ...
	        e.printStackTrace(); // Handle the exception appropriately (logging, throwing, etc.)
	        return false;
	    }
