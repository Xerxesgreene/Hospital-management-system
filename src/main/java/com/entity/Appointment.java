...
public class Appointment {
	...
	public Appointment(int userId, String fullName, String gender, String age, String appoinDate, String appoinTime, String email,
			String phNo, String diseases, int doctorId, String address, String status, String approvalStatus) {
		super();
		this.userId = userId;
